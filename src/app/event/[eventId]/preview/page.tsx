        ...
        <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ type: 'spring', damping: 14 }}
          ...
          {submittedPhotoId && (
            <motion.button
              ...
              className="w-full py-4 rounded-2xl text-lg font-bold border border-red-500/30 mb-3 active:scale-95 transition-transform flex items-center justify-center gap-2"
